...
const generateHTMLPlugins = () =>
  glob.sync("./src/*.html").map((dir) => {
    ...
    return new HtmlWebpackPlugin({
      ...
      favicon: `./src/images/logo/favicon.png`,
      inject: "body",
    });
  });
        ...
        options: {
          ...
          sources: {
            urlFilter: (attribute, value) => {
              ...
              if (value === "/edeka.png" || value === "/iberiana.png" || value === "/eurogroup.png" || value === "/anecoop.png" || value === "/greenyard_2.png" || value === "/alfruit.png" || value === "/pelican.png" || value === "/img.jpg" || value === "/lehman.png" || value === "/daifressh.png" || value === "/garcialax.png") return false;
              return true;
            },
          },
        },
