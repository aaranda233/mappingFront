export default function estadoPedidosAlfruitManager() {
    return {
        ...
        _endpoint: 'estado-pedidos-alfruit',
        ...
        async loadEstadoActual() {
            try {
                ...
                console.error("Error cargando estado actual Alfruit:", err);
            } finally {
                this.loaded = true;
            }
        },
        ...
        async loadHistorial() {
            try {
                const res = await fetch(`http://${window.env.IP_BACKEND}/api/mapping/estado-pedidos-alfruit/historial${this._centroQuery()}`);
                ...
                console.error("Error cargando historial Alfruit:", err);
            }
        },
